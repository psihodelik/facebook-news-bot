...
exports.LINK_COUNT = 5
exports.MAX_LINKS = 25  //This is the page-size when we use the capi results field. This is
                        //the same as the max number of editors-picks/most-viewed in a response.
